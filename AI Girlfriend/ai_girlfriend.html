...
<body>
    ...
    <script>
        ...
        const responses = {
            howAreYou: [
                "I'm feeling {mood} today! Thank you for asking. How about you?",
                "I'm having a {mood} day! How are you doing?",
                "Right now I'm feeling pretty {mood}! What about yourself?"
            ],
            whatDoingLater: [
            ...
            compliment: [
                "Oh! You're making me blush! Thank you so much!",
                "That's so sweet of you to say! You know how to make me feel special.",
            ...
            userSad: [
                ...
                "That sounds tough. I'm here for you if you want to talk about it.",
            ...
            userAngry: [
                "boy i know u like dih",
                "It sounds like you're having a rough time. I'm here to listen if you need to vent.",
                "I'm sorry things aren't going well. Is there anything that might help you feel better?"
            ],
            food: [
                "can i eyp",
                "That sounds delicious! I wish I could taste it!",
                "Food is such a great way to connect! What cuisine do you enjoy most?"
            ],
            movies: [
            ...
            music: [
                "Music can really set the mood! What are you listening to lately?",
                "I'd love to dance with you to your favorite song!",
                "Music is so powerful, isn't it? What artists do you enjoy?"
            ],
            weekend: [
                "Weekends are precious! Any exciting plans?",
                "I hope you get some well-deserved rest and fun this weekend!",
                "Weekends always go by too quickly! Make sure to enjoy every minute!"
            ],
            weather: [
            ...
            joke: [
                ...
                "I'd tell you a joke about virtual reality, but it hasn't become a reality yet!"
            ],
            travel: [
            ...
            books: [
                "Books can transport us to different worlds! What are you reading?",
                "I love a good story! What's your favorite genre?",
                "Reading is such a wonderful escape! Any recommendations?"
            ],
            default: [
